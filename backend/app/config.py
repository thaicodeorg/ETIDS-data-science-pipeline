...
class Settings(BaseSettings):
    ...
    data_zip_path: Path = Field(default=Path("/app/data/seed/obe03_manufacturing_synthetic_dataset_v1.zip"), alias="DATA_ZIP_PATH")
    ...
    def dataset_root(self) -> Path:
        return self.data_extract_dir / "obe03_manufacturing_synthetic_dataset_v1"
