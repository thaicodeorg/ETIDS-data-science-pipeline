# OBE03 Manufacturing Data Science Pipeline Stack — Revised Flow
...
|---|---|---|
| Raw data | `data/seed/obe03_manufacturing_synthetic_dataset_v1.zip` | ERP, MES, SCADA, QMS, CMMS, logistics data |
...
```bash
docker compose exec airflow airflow users create -u admin -p admin -f OBE03 -l Admin -r Admin -e admin@example.com
```
